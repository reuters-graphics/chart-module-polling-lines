...
<script>
  ...
  // Installation docs
  const installDocs = `$ yarn add https://github.com/reuters-graphics/chart-module-polls-line-chart.git`;

  // JavaScript docs
  $: jsDocs = `import Chart from '@reuters-graphics/chart-module-polls-line-chart';
...
`;
  ...
  // SCSS docs
  const styleDocs = `$LineChart-container: '.polls-line-chart-container';
...
<div class='repo-link'>
  <a href="https://github.com/reuters-graphics/chart-module-polls-line-chart" target="_blank">
    <Icon icon={faGithub} />
  </a>
</div>
